...
class STORN(object):
    ...
    def encoding_step(self, h_t, x_t):
        ...
        output_encoding_step = tf.transpose(self.activation_function(first_term + second_term + self.b_he),
                                            name="output_encoding_step")
    ...
    def encoder_rnn(self, x):
        ...
        if self.flow_type == "Planar":
            ...
            self.alphas = tf.nn.softplus(self.alphas, name="alpha_softplused")
    ...
    def decoding_step_storn_without_input(self, previous_output, z_t):
        """
    ...
    def decoding_step_storn_with_input(self, previous_output, current_input):
    ...
    def decoder_rnn(self, z, model_type="storn_with_input", **kwargs):
        """
        ...
        :param flow_type: STORN with or without input.
